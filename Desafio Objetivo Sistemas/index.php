...
class ClienteTelefone
{
    ...
    public function __construct($telefone, $conexao)
    {
    ...
    {
        $inserirTelefone = $this->conexao->prepare("INSERT INTO cliente_telefone (telefone) VALUES (?)");
        $inserirTelefone->bind_param("s", $this->telefone);
...
class Cliente
{
    ...
    public function __construct($nome, $observacao, $clienteTelefone, $conexao)
    {
        $this->nome = $nome;
    ...
    public function salvarNoBanco()
    {
        $clienteTelefoneId = $this->clienteTelefone->salvarNoBanco();

        if ($clienteTelefoneId) {
            $inserirCliente = $this->conexao->prepare("INSERT INTO cliente (nome, observacao, cliente_telefone_id_cliente_telefone) VALUES (?, ?, ?)");
            $inserirCliente->bind_param("ssi", $this->nome, $this->observacao, $clienteTelefoneId);

            return $inserirCliente->execute();
        }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $conexao = new mysqli("localhost", "root", " ", "desafio");

    if ($conexao->connect_error) {
        die("Erro na conexão: " . $conexao->connect_error);
    }

    $clienteTelefone = new ClienteTelefone($telefone, $conexao);
    $cliente = new Cliente($nome, $observacao, $clienteTelefone, $conexao);
